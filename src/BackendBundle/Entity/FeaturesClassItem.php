...
/**
 * @ORM\Entity()
 * @ORM\Table(name="room_class_features_table")
 * @Vich\Uploadable
 */
class FeaturesClassItem
{
    /**
     * @ORM\Id
...
//    }
    ...
    /**
     * @param \BackendBundle\Entity\RoomClass $c
     *
     * @return FeaturesClassItem
     */
    public function setI(\BackendBundle\Entity\RoomClass $c = null)
    {
        $this->i = $c;
