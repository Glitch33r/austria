...
/**
 * @ORM\Entity()
 * @ORM\Table(name="adventure_parts_table")
 * @Vich\Uploadable
 */
class AdventurePart
{
    ...
    /**
     * @Vich\UploadableField(mapping="adventures", fileNameProperty="image")
     * @var File
     */
    private $imageFile;
    ...
    /**
     * @param \BackendBundle\Entity\Adventure
     *
     * @return AdventurePart
     */
    public function setAdv(\BackendBundle\Entity\Adventure $am = null)
    {
        $this->adv = $am;
